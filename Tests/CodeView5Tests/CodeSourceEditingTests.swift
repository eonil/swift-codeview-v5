...
final class CodeSourceEditingTests: XCTestCase {
    func testInsertNewLine() {
        ...
        XCTAssertEqual(ed.storage.text.lines[0].content, "")
        ...
        XCTAssertEqual(ed.storage.text.lines.count, 1)
        XCTAssertEqual(ed.storage.text.lines[0].content, "aaa")
        ...
        XCTAssertEqual(ed.storage.text.lines[0].content, "aaa")
        XCTAssertEqual(ed.storage.text.lines[1].content, "")
        ...
        XCTAssertEqual(ed.storage.text.lines.count, 2)
        XCTAssertEqual(ed.storage.text.lines[0].content, "aaa")
        XCTAssertEqual(ed.storage.text.lines[1].content, "bbb")
    ...
    func testDeleteSecondLine() {
        ...
        XCTAssertEqual(ed.storage.text.lines.count, 2)
        XCTAssertEqual(ed.storage.text.lines[0].content, "aaa")
        XCTAssertEqual(ed.storage.text.lines[1].content, "bb")
        ed.apply(.typing(.processEditingCommand(.deleteBackward)))
        XCTAssertEqual(ed.storage.text.lines.count, 2)
        XCTAssertEqual(ed.storage.text.lines[0].content, "aaa")
        XCTAssertEqual(ed.storage.text.lines[1].content, "b")
        ed.apply(.typing(.processEditingCommand(.deleteBackward)))
        XCTAssertEqual(ed.storage.text.lines.count, 2)
        XCTAssertEqual(ed.storage.text.lines[0].content, "aaa")
        XCTAssertEqual(ed.storage.text.lines[1].content, "")
    ...
    func testInsertTwoAndDeleteOne() {
        ...
        XCTAssertEqual(ed.storage.text.lines.count, 1)
        XCTAssertEqual(ed.storage.text.lines[0].content, "a")
        ...
        XCTAssertEqual(ed.storage.text.lines.count, 1)
        XCTAssertEqual(ed.storage.text.lines[0].content, "ab")
...
"""
    ...
    func testSelectAllAndDeleteBackward() {
        ...
        let x1 = ed.storage.text.lines.map({ $0.content }).joined(separator: "\n")
        XCTAssertEqual(x1, "aaa\nbbb\nccc")
        ed.apply(.typing(.processEditingCommand(.moveToBeginningOfDocumentAndModifySelection)))
        ed.apply(.typing(.processEditingCommand(.deleteBackward)))
        let x2 = ed.storage.text.lines.map({ $0.content }).joined(separator: "\n")
        XCTAssertEqual(x2, "")
    }
